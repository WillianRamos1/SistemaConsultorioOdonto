...
namespace SistemaOdonto
{
    public partial class FrmConsultas : Form
    {
        ...
        {
            var listaD = serviceDentista.Listar();
        ...
        private void Tabela_Clicada(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Paciente p = servicePaciente.Buscar(c.IdPaciente);
        ...
        {
            var dentista = serviceDentista.Buscar(dentistaId);
            List<Consulta> consultas = service.Buscar(dentista, Convert.ToDateTime(DateTimeHora.Value.ToString("dd/MM/yyyy"))).OrderBy(x => x.HoraMarcada).ToList();
            ...
            foreach(var consulta in consultas)
            {
                ...
                dgv.Rows[linhaAtual].Cells[2].Value = servicePaciente.Buscar(Convert.ToInt32(consulta.IdPaciente)).Nome;
        ...
        {
            DateTimeHora.Value = DateTimeHora.Value.AddDays(1);
            AtualizarLinhas();
        }
